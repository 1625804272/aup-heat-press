...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      fam_model_unit: "款机型",
      fam_view_spec: "查看详情 →",
      fam_view_detail: "查看详情 →",
      fam_view_scenario: "查看应用场景 →",
      back_to_families: "← 返回产品系列",
      series_models_title: "机型列表",
      series_models_hint: "点击下方任一机型，查看完整规格、颜色与结算价",
      detail_missing: "未找到对应产品，请返回产品系列",
      scenarios_title: "应用场景",
      scenarios_hint: "以下为该系列的典型使用环境与适用情境",
    ...
    en: {
      ...
      hero_btn_families: "Browse product lines",
      ...
      fam_view_spec: "View details →",
      fam_view_detail: "View details →",
      fam_view_scenario: "View application scenarios →",
      back_to_families: "← Back to product lines",
      series_models_title: "Models",
      series_models_hint: "Tap any model for full specs, colors and prices",
      detail_missing: "Product not found. Please go back to product lines.",
      scenarios_title: "Application Scenarios",
      scenarios_hint: "Typical usage environments and applicable situations for this series.",
    ...
    ru: {
      ...
      cmp_volt: "Напряжение",
      cmp_color: "Цвета",
      cmp_price: "Базовая цена",
      cmp_tier: "Ступенчатая цена",
      nav_stock: "Склад",
      ...
      hero_btn_families: "Смотреть серии",
      ...
      fam_view_spec: "Подробнее →",
      fam_view_detail: "Подробнее →",
      fam_view_scenario: "Сценарии применения →",
      back_to_families: "← К линейкам продукции",
      series_models_title: "Модели",
      series_models_hint: "Нажмите модель для полных характеристик, цветов и цен",
      detail_missing: "Продукт не найден. Вернитесь к линейкам.",
      scenarios_title: "Сценарии применения",
      scenarios_hint: "Типичные ситуации использования данной серии.",
    ...
    es: {
      ...
      cmp_volt: "Voltaje",
      cmp_color: "Colores",
      cmp_price: "Precio base",
      cmp_tier: "Precio por escalón",
      ...
      hero_btn_families: "Ver las series",
      ...
      fam_view_spec: "Ver detalles →",
      fam_view_detail: "Ver detalles →",
      fam_view_scenario: "Ver escenarios de uso →",
      back_to_families: "← Volver a las líneas",
      series_models_title: "Modelos",
      series_models_hint: "Toca un modelo para ver especificaciones, colores y precios",
      detail_missing: "Producto no encontrado. Vuelve a las líneas.",
      scenarios_title: "Escenarios de uso",
      scenarios_hint: "Entornos y situaciones típicas de uso de esta serie.",
